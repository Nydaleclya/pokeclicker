...
FarmHands.add(new FarmHand('Starf', 100, 50, FarmHandSpeeds.UltraFast, 10, -12, new TotalBerriesUnlockedRequirement(8)));
FarmHands.add(new FarmHand('Lum', 100, 50, FarmHandSpeeds.UltraFast, 10, -12, new TotalBerriesUnlockedRequirement(8)));
FarmHands.add(new FarmHand('Chople', 100, 50, FarmHandSpeeds.UltraFast, 10, -12, new TotalBerriesUnlockedRequirement(8)));
